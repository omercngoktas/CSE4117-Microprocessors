...
SIGNAL \scanSpeed[1]~3_combout\ : std_logic;
SIGNAL \scanSpeed[4]~7_combout\ : std_logic;
SIGNAL \scanSpeed[1]~2_combout\ : std_logic;
SIGNAL \scanSpeed[2]~4_combout\ : std_logic;
SIGNAL \scanSpeed[3]~5_combout\ : std_logic;
SIGNAL \scanSpeed[3]~6_combout\ : std_logic;
SIGNAL \scanSpeed[1]~0_combout\ : std_logic;
SIGNAL \scanSpeed[1]~1_combout\ : std_logic;
...
-- Equation(s):
-- \Equal1~0_combout\ = (scanSpeed(4)) # ((scanSpeed(3)) # ((scanSpeed(2)) # (scanSpeed(1))))
...
\scanSpeed[1]~3\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[1]~3_combout\ = (\rightButton~input_o\ & !\rightButtonPrev~q\)
...
PORT MAP (
	...
	datad => \rightButtonPrev~q\,
	combout => \scanSpeed[1]~3_combout\);

-- Location: LCCOMB_X28_Y1_N6
\scanSpeed[4]~7\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[4]~7_combout\ = (\scanSpeed[1]~2_combout\ & ((\scanSpeed[1]~3_combout\ & (!\Equal1~0_combout\)) # (!\scanSpeed[1]~3_combout\ & ((scanSpeed(4)))))) # (!\scanSpeed[1]~2_combout\ & (((scanSpeed(4)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \scanSpeed[1]~2_combout\,
	datab => \Equal1~0_combout\,
	datac => scanSpeed(4),
	datad => \scanSpeed[1]~3_combout\,
	combout => \scanSpeed[4]~7_combout\);
...
PORT MAP (
	clk => \clk~input_o\,
	d => \scanSpeed[4]~7_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => scanSpeed(4));

-- Location: LCCOMB_X28_Y1_N28
\scanSpeed[1]~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[1]~2_combout\ = (scanSpeed(2) & (!scanSpeed(3) & (scanSpeed(1) & scanSpeed(4)))) # (!scanSpeed(2) & (!scanSpeed(4) & (scanSpeed(3) $ (!scanSpeed(1)))))
...
PORT MAP (
	...
	datac => scanSpeed(1),
	datad => scanSpeed(4),
	combout => \scanSpeed[1]~2_combout\);

-- Location: LCCOMB_X28_Y1_N26
\scanSpeed[2]~4\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[2]~4_combout\ = (\scanSpeed[1]~2_combout\ & ((\scanSpeed[1]~3_combout\ & (!\Equal1~0_combout\)) # (!\scanSpeed[1]~3_combout\ & ((scanSpeed(2)))))) # (!\scanSpeed[1]~2_combout\ & (((scanSpeed(2)))))
...
PORT MAP (
	clk => \clk~input_o\,
	d => \scanSpeed[2]~4_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => scanSpeed(2));

-- Location: LCCOMB_X28_Y1_N24
\scanSpeed[3]~5\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[3]~5_combout\ = (scanSpeed(2) & (!scanSpeed(3) & ((!scanSpeed(4)) # (!\rightButton~input_o\)))) # (!scanSpeed(2) & (((\rightButton~input_o\ & !scanSpeed(4))) # (!scanSpeed(3))))
...
PORT MAP (
	...
	datac => \rightButton~input_o\,
	datad => scanSpeed(4),
	combout => \scanSpeed[3]~5_combout\);

-- Location: LCCOMB_X28_Y1_N2
\scanSpeed[3]~6\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[3]~6_combout\ = (\rightButtonPrev~q\ & (((scanSpeed(3))))) # (!\rightButtonPrev~q\ & ((scanSpeed(1) & ((!\scanSpeed[3]~5_combout\))) # (!scanSpeed(1) & (scanSpeed(3)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \rightButtonPrev~q\,
	datab => scanSpeed(1),
	datac => scanSpeed(3),
	datad => \scanSpeed[3]~5_combout\,
	combout => \scanSpeed[3]~6_combout\);
...
PORT MAP (
	clk => \clk~input_o\,
	d => \scanSpeed[3]~6_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => scanSpeed(3));

-- Location: LCCOMB_X29_Y1_N4
\scanSpeed[1]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[1]~0_combout\ = (scanSpeed(2)) # ((scanSpeed(4)) # (!\rightButton~input_o\))
...
PORT MAP (
	...
	datac => scanSpeed(4),
	combout => \scanSpeed[1]~0_combout\);

-- Location: LCCOMB_X28_Y1_N0
\scanSpeed[1]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \scanSpeed[1]~1_combout\ = (\rightButtonPrev~q\ & (((scanSpeed(1))))) # (!\rightButtonPrev~q\ & ((\scanSpeed[1]~0_combout\ & ((scanSpeed(1)))) # (!\scanSpeed[1]~0_combout\ & (!scanSpeed(3)))))
...
PORT MAP (
	...
	datab => scanSpeed(3),
	datac => scanSpeed(1),
	datad => \scanSpeed[1]~0_combout\,
	combout => \scanSpeed[1]~1_combout\);
...
-- Equation(s):
-- \Mux0~1_combout\ = (scanSpeed(1) & ((clk1(7)))) # (!scanSpeed(1) & (clk1(5)))
...
-- Equation(s):
-- \Mux0~0_combout\ = (scanSpeed(1) & ((clk1(3)))) # (!scanSpeed(1) & (clk1(1)))
...
-- Equation(s):
-- \Mux0~2_combout\ = (scanSpeed(2) & (!\Mux0~1_combout\)) # (!scanSpeed(2) & ((!\Mux0~0_combout\)))
...
-- Equation(s):
-- \Mux0~3_combout\ = (scanSpeed(1) & (clk1(11))) # (!scanSpeed(1) & ((clk1(9))))
...
-- Equation(s):
-- \Mux0~4_combout\ = (scanSpeed(1) & (clk1(15))) # (!scanSpeed(1) & ((clk1(13))))
...
-- Equation(s):
-- \Mux0~5_combout\ = (scanSpeed(2) & ((!\Mux0~4_combout\))) # (!scanSpeed(2) & (!\Mux0~3_combout\))
...
-- Equation(s):
-- \Mux0~6_combout\ = (scanSpeed(3) & (\Mux0~2_combout\)) # (!scanSpeed(3) & ((\Mux0~5_combout\)))
...
-- Equation(s):
-- \Mux0~10_combout\ = (!scanSpeed(1) & clk1(25))
...
-- Equation(s):
-- \Mux0~11_combout\ = (scanSpeed(2)) # (!\Mux0~10_combout\)
...
-- Equation(s):
-- \Mux0~8_combout\ = (scanSpeed(1) & ((clk1(23)))) # (!scanSpeed(1) & (clk1(21)))
...
-- Equation(s):
-- \Mux0~7_combout\ = (scanSpeed(1) & ((clk1(19)))) # (!scanSpeed(1) & (clk1(17)))
...
-- Equation(s):
-- \Mux0~9_combout\ = (scanSpeed(2) & (!\Mux0~8_combout\)) # (!scanSpeed(2) & ((!\Mux0~7_combout\)))
...
-- Equation(s):
-- \Mux0~12_combout\ = (scanSpeed(3) & ((\Mux0~9_combout\))) # (!scanSpeed(3) & (\Mux0~11_combout\))
...
-- Equation(s):
-- \rtl~0_combout\ = LCELL((scanSpeed(4) & (!\Mux0~6_combout\)) # (!scanSpeed(4) & ((!\Mux0~12_combout\))))
...
-- Equation(s):
-- \Mux2~0_combout\ = (count(1) & ((count(0)) # ((!number(10))))) # (!count(1) & (!count(0) & ((!number(2)))))
...
-- Equation(s):
-- \Mux4~0_combout\ = (count(1) & (count(0))) # (!count(1) & ((count(0) & (number(4))) # (!count(0) & ((!number(0))))))
...
-- Equation(s):
-- \Mux4~1_combout\ = (count(1) & ((\Mux4~0_combout\ & (!number(12))) # (!\Mux4~0_combout\ & ((!number(8)))))) # (!count(1) & (((\Mux4~0_combout\))))
...
-- Equation(s):
-- \WideOr6~0_combout\ = (\Mux4~1_combout\ & ((\Mux1~1_combout\) # (\Mux3~1_combout\ $ (\Mux2~1_combout\)))) # (!\Mux4~1_combout\ & ((\Mux3~1_combout\) # (\Mux2~1_combout\ $ (\Mux1~1_combout\))))
...
-- Equation(s):
-- \WideOr5~0_combout\ = (\Mux3~1_combout\ & (!\Mux1~1_combout\ & ((\Mux4~1_combout\) # (!\Mux2~1_combout\)))) # (!\Mux3~1_combout\ & (\Mux4~1_combout\ & (\Mux2~1_combout\ $ (!\Mux1~1_combout\))))
