...
//========================================   FIRST PASS  ======================================================
            while (token)
            {
                ...
                else if (strcmp(token,"st")==0) //-------------ST INSTRUCTION--------------------
                {
                    ...
                    program[counter] = 0x3000 + ((ch)&0x01ff);
                    counter++;
                }
                ...
                else if (strcmp(token,"sub")==0)
                {
                    ...
                    op2 = strtok(NULL, "\n\t\r ");
                    op3 = strtok(NULL, "\n\t\r ");
                    ch = (op1[0] - 48) | ((op2[0] - 48) << 6) | ((op3[0] - 48) << 3);
                    program[counter] = 0x7000 + ((ch)&0x03ff);
                    counter++;
                }
                else if (strcmp(token,"and")==0)
                {
                    ...
                    op3 = strtok(NULL, "\n\t\r ");
                    ch = (op1[0] - 48) | ((op2[0] - 48) << 6) | ((op3[0] - 48) << 3);
                    program[counter] = ((ch)&0x05ff) + 0x7000;
                    counter++;
                }
                else if (strcmp(token,"or")==0)
                {
                    ...
                    op3 = strtok(NULL, "\n\t\r ");
                    ch = (op1[0] - 48) | ((op2[0] - 48) << 6) | ((op3[0] - 48) << 3);
                    program[counter] = 0x7000 + ((ch)&0x07ff);
                    counter++;
                }
                else if (strcmp(token,"xor")==0)
                {
                    ...
                    op3 = strtok(NULL, "\n\t\r ");
                    ch = (op1[0] - 48) | ((op2[0] - 48) << 6) | ((op3[0] - 48) << 3);
                    program[counter] = 0x7000 + ((ch)&0x09ff);
                    counter++;
                }                        
